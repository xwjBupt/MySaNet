...
import math
from util.get_density_map import get_density_map_gaussian
...
class SHTech(Dataset):
    ...
    def __init__(self,imdir,gtdir,transform = 0,train = True,test = False,raw = False,num_cut = 4):
        self.imdir = imdir
        self.gtdir = gtdir
        self.train = train
        self.test = test
        ...
        for idx in range(self.num_it):
            ...
            if self.test:
                ...
                den = get_density_map_gaussian(img, annPoints)
